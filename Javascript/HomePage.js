...
function product_1_detect() {
    if (product_1.getAttribute("src") === "/fashionweb/icons/cart_bt.png") {
        addProduct_1();
    } else {
        removeProduct_1();
    }
...
function product_2_detect() {
    if (product_2.getAttribute("src") === "/fashionweb/icons/cart_bt.png") {
        addProduct_2();
    } else {
        removeProduct_2();
    }
...
function product_3_detect() {
    if (product_3.getAttribute("src") === "/fashionweb/icons/cart_bt.png") {
        addProduct_3();
    } else {
        removeProduct_3();
    }
...
function product_4_detect() {
    if (product_4.getAttribute("src") === "/fashionweb/icons/cart_bt.png") {
        addProduct_4();
    } else {
        removeProduct_4();
    }
...
function product_5_detect() {
    if (product_5.getAttribute("src") === "/fashionweb/icons/cart_bt.png") {
        addProduct_5();
    } else {
        removeProduct_5();
    }
...
function product_6_detect() {
    if (product_6.getAttribute("src") === "/fashionweb/icons/cart_bt.png") {
        addProduct_6();
    } else {
        removeProduct_6();
    }
...
function product_7_detect() {
    if (product_7.getAttribute("src") === "/fashionweb/icons/cart_bt.png") {
        addProduct_7();
    } else {
        removeProduct_7();
    }
...
function product_8_detect() {
    if (product_8.getAttribute("src") === "/fashionweb/icons/cart_bt.png") {
        addProduct_8();
    } else {
        removeProduct_8();
    }
...
function addProduct_8() {
    ...
    product_8.src = "/fashionweb/icons/cart_bt_clicked.png";
...
function removeProduct_8() {
    ...
    product_8.src = "/fashionweb/icons/cart_bt.png";
...
function product_9_detect() {
    if (product_9.getAttribute("src") === "/fashionweb/icons/cart_bt.png") {
        addProduct_9();
    } else {
        removeProduct_9();
    }
...
function addProduct_9() {
    ...
    // calculating the subtotal price
    subtotalPrice += parseFloat(scarfs_price[8].innerHTML.slice(1));
    document.getElementById("subtotalPrice").innerHTML = subtotalPrice.toFixed(2);

    product_9.src = "/fashionweb/icons/cart_bt_clicked.png";
...
function removeProduct_9() {
    ...
    product_9.src = "/fashionweb/icons/cart_bt.png";
...
function product_10_detect() {
    if (product_10.getAttribute("src") === "/fashionweb/icons/cart_bt.png") {
        addProduct_10();
    } else {
        removeProduct_10();
    }
...
function addProduct_10() {
    ...
    // calculating the subtotal price
    subtotalPrice += parseFloat(scarfs_price[9].innerHTML.slice(1));
    document.getElementById("subtotalPrice").innerHTML = subtotalPrice.toFixed(2);

    product_10.src = "/fashionweb/icons/cart_bt_clicked.png";
...
function removeProduct_10() {
    ...
    product_10.src = "/fashionweb/icons/cart_bt.png";
...
function product_11_detect() {
    if (product_11.getAttribute("src") === "/fashionweb/icons/cart_bt.png") {
        addProduct_11();
    } else {
        removeProduct_11();
    }
...
function addProduct_11() {
    ...
    // calculating the subtotal price
    subtotalPrice += parseFloat(scarfs_price[10].innerHTML.slice(1));
    document.getElementById("subtotalPrice").innerHTML = subtotalPrice.toFixed(2);

    product_11.src = "/fashionweb/icons/cart_bt_clicked.png";
...
function removeProduct_11() {
    ...
    product_11.src = "/fashionweb/icons/cart_bt.png";
...
function product_12_detect() {
    if (product_12.getAttribute("src") === "/fashionweb/icons/cart_bt.png") {
        addProduct_12();
    } else {
        removeProduct_12();
    }
...
function addProduct_12() {
    ...
    // calculating the subtotal price
    subtotalPrice += parseFloat(scarfs_price[11].innerHTML.slice(1));
    document.getElementById("subtotalPrice").innerHTML = subtotalPrice.toFixed(2);

    product_12.src = "/fashionweb/icons/cart_bt_clicked.png";
...
function removeProduct_12() {
    ...
    product_12.src = "/fashionweb/icons/cart_bt.png";

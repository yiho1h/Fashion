...
function checked_1() {
    shipMethod_checked[0].style.backgroundColor = "#d5124320";
    shipMethod_checked[0].style.borderColor = "#d51243";
    shipMethod_checked[1].style.backgroundColor = "transparent";
    shipMethod_checked[1].style.borderColor = "#ACACAC";
} 
function checked_2() {
    shipMethod_checked[1].style.backgroundColor = "#d5124320";
    shipMethod_checked[1].style.borderColor = "#d51243";
    shipMethod_checked[0].style.backgroundColor = "transparent";
...
userInfo_form.addEventListener("submit", function(e) {
	...
	document.getElementById("user_email0").innerHTML = emailNew;
    document.getElementById("user_address0").innerHTML = addressNew + " " + cityNew + " " 
        + stateNew + " " + postcodeNew + " " + countryNew;
	document.getElementById("user_name").innerHTML = lastNameNew;
});
...
payment.addEventListener("submit", function(e) {
    ...
    // to make the month and day in the format of mm
